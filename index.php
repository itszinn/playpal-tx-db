...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm login-card border-0 overflow-hidden">
                <div class="p-4 login-hero text-center">
                    <h3 class="mb-1">Login Admin</h3>
                    <p class="text-muted mb-0">Akses dashboard transaksi PlayPal.</p>
                </div>
                <div class="card-body">
                    <h5 class="card-title mb-4">Masuk sebagai admin</h5>
                    <?php if (!empty($errors)): ?>
